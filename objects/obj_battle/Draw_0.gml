...
draw_ellipse(_ellipse_corner_x1, _ellipse_corner_y1 + 20, _ellipse_corner_x2, _ellipse_corner_y2 + 20, false);
draw_rectangle(_ellipse_corner_x1 + 1, _ellipse_center_y, _ellipse_corner_x2, _ellipse_center_y + 20, false)
